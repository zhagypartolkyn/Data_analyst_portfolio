# Overview
This EDA for Kaggle datasets is a part of AI travel planning assistant project. 
Briefly about this project: web-app on Streamlit that shows you hotels, flights, restaurants anditineriries based on your budget and destination.
Hotels and flights work with real-time APIs.
Restaurants and itineraries are collected, cleaned and retrieved with RAG.
👉🏻How it works: https://youtu.be/L3zfT3UUH4I
